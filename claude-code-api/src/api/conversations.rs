...
pub async fn create_conversation(
    ...
    let id = state.manager.create_conversation(request.model.clone());
...
pub async fn get_conversation(
    ...
    let conversation = state.manager.get_conversation(&conversation_id)
...
pub async fn list_conversations(
    ...
    let conversations = state.manager.list_active_conversations();
