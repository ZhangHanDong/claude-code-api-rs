...
fn main() {
    ...
    println!("   Created options with settings: {:?}", options_with_settings.settings);
    println!();
    ...
    println!("   Additional directories: {:?}", options_single_dir.add_dirs);
    println!();
    ...
    let options_multi_dir = ClaudeCodeOptions::builder()
        .add_dirs(dirs.clone())
        .build();
    
    println!("   Added {} directories at once:", options_multi_dir.add_dirs.len());
    ...
    println!("   Additional dirs: {} directories", complete_options.add_dirs.len());
